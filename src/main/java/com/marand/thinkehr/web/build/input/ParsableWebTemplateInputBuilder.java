 ...
 * @author Matic Ribic
 */
public class ParsableWebTemplateInputBuilder implements WebTemplateInputBuilder<Object> {
    ...
    public void build(WebTemplateNode node, WebTemplateBuilderContext context) {
        ...
        node.getInputs().add(createInput(node, WebTemplateConstants.VALUE_ATTRIBUTE, defaultValue != null ? defaultValue.getValue() : null));
        node.getInputs().add(createInput(node, WebTemplateConstants.FORMALISM_ATTRIBUTE, defaultValue != null ? defaultValue.getFormalism() : null));
    }

    protected WebTemplateInput createInput(WebTemplateNode node, String suffix, Object defaultValue) {

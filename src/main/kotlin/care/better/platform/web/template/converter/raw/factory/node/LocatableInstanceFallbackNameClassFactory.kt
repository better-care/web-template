 ...
 * @since 3.1.0
 *
 * Instance of [LocatableFactory] that creates a new instance of [Locatable] using reflection and sets locatable name if missing.
 * This is useful for classes with unknown generic types.
 *
 * @constructor Creates a new instance of [LocatableInstanceFallbackNameClassFactory]
 * @param rmClass [Locatable] [Class] for which a new instance will be created
 */
internal open class LocatableInstanceFallbackNameClassFactory<T : Locatable>(private val rmClass: Class<T>) : LocatableFactory<T>() {

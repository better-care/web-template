 ...
 * @since 3.1.0
 *
 * Singleton instance of [SpecialCaseRmObjectHandler] that handles "history_origin" attribute.
 */
internal object HistoryOriginHandler : SpecialCaseRmObjectHandler {
    const val specialAttribute: String = "history_origin"

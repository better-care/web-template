 ...
 * @since 3.1.0
 *
 * Singleton instance of [RmObjectToStructuredMapper] that maps [DvBoolean] to STRUCTURED format.
 */
internal object DvBooleanToStructuredMapper : RmObjectToStructuredMapper<DvBoolean> {
    override fun map(webTemplateNode: WebTemplateNode, valueConverter: ValueConverter, rmObject: DvBoolean): JsonNode =
        if (rmObject.value) BooleanNode.TRUE else BooleanNode.FALSE

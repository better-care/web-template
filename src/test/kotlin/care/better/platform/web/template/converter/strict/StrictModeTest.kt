...
class StrictModeTest : AbstractWebTemplateTest() {
    ...
    fun testStrictDateTimeParsing() {
        ...
        val values: Map<String, Any> = mapOf(
            "medical_document/document/date_last_reviewed" to "2012-12-01",
    ...
    fun testNullInStructuredFormat() {
        val compositionObjectNode =
            getObjectMapper().readTree(getJson("/convert/compositions/strict/IDCR_-_Laboratory_Test_Report(1) - Structured - Null Leaf Value.json")) as ObjectNode
    ...
    fun testBlankInStructuredFormat() {
        val compositionObjectNode: ObjectNode =
            getObjectMapper().readTree(getJson("/convert/compositions/strict/IDCR_-_Laboratory_Test_Report(1) - Structured - Blank Leaf Value.json")) as ObjectNode
    ...
    fun testNullDvQuantity() {
        val compositionObjectNode: ObjectNode =
            getObjectMapper().readTree(getJson("/convert/compositions/strict/IDCR_-_Laboratory_Test_Report(1) - Null Leaf Node.json")) as ObjectNode
    ...
    fun testEmptyLeafObjectNode() {
        val compositionObjectNode: ObjectNode =
            getObjectMapper().readTree(getJson("/convert/compositions/strict/IDCR_-_Laboratory_Test_Report(1) - Empty Leaf Node.json")) as ObjectNode
